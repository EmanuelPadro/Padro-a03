...
/*Program description: Each of the get functions takes input and evaluate using if statements and other text/pattern recognition so that
...
public class Solution27 {
    ...
    //each tester function such as GetFirstName shall test input for errors then there will be an array of strings
// that will have errors added to it, if the array is empty there were no errors and "no errors" printed
...
//same method as above but for last name
    ...
    public static void main(String[] args) {
        ...
        Load(Errors);
        new ex27Database(FirstName,LastName,ZipCode,EmployeeID);
